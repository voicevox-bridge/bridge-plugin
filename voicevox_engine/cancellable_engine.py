...
class CancellableEngine:
    ...
    パラメータ use_gpu, enable_mock は、 make_synthesis_engines を参照
    ...
    def __init__(
        ...
        self.bridge_config_dir = bridge_config_dir
    ...
    def start_new_proc(
        ...
        ret_proc = Process(
            ...
            kwargs={
                ...
                "bridge_config_dir": self.bridge_config_dir,
...
def start_synthesis_subprocess(
    ...
    引数 use_gpu, enable_mock は、 make_synthesis_engines を参照
    ...
    synthesis_engines = make_synthesis_engines(
        ...
        bridge_config=BridgeConfigLoader(bridge_config_dir),
    )
